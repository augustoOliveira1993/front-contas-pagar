...
function TimelineIndicator({
  ...
  return (
    <div
      ...
      className={cn(
        "group-data-[orientation=horizontal]/timeline:-top-6 group-data-[orientation=vertical]/timeline:top-0 group-data-[orientation=horizontal]/timeline:left-0 group-data-[orientation=vertical]/timeline:-left-6 absolute bg-muted border-2 border-muted-foreground/20 group-data-completed/timeline-item:border-primary rounded-full size-4 group-data-[orientation=horizontal]/timeline:-translate-y-1/2 group-data-[orientation=vertical]/timeline:-translate-x-1/2",
        className
      )}
      aria-hidden="true"
      {...props}
